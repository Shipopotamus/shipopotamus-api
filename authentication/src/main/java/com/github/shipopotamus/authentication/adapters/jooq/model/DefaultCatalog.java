...
public class DefaultCatalog extends CatalogImpl {
    ...
    /**
     * The schema <code>authentication_schema</code>.
     */
    public final AuthenticationSchema AUTHENTICATION_SCHEMA = AuthenticationSchema.AUTHENTICATION_SCHEMA;
    ...
    public final List<Schema> getSchemas() {
        return Arrays.asList(
            AuthenticationSchema.AUTHENTICATION_SCHEMA
        );
    }
