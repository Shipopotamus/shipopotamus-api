...
public class Accounts extends TableImpl<AccountsRecord> {
    ...
    /**
     * The reference instance of <code>authentication_schema.accounts</code>
     */
    ...
    /**
     * The column <code>authentication_schema.accounts.id</code>.
     */
    public final TableField<AccountsRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>authentication_schema.accounts.user_id</code>.
     */
    public final TableField<AccountsRecord, UUID> USER_ID = createField(DSL.name("user_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>authentication_schema.accounts.email</code>.
     */
    public final TableField<AccountsRecord, String> EMAIL = createField(DSL.name("email"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>authentication_schema.accounts.created_at</code>.
     */
    public final TableField<AccountsRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>authentication_schema.accounts.modified_at</code>.
     */
    public final TableField<AccountsRecord, OffsetDateTime> MODIFIED_AT = createField(DSL.name("modified_at"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>authentication_schema.accounts</code> table
     * reference
     */
    ...
    /**
     * Create a <code>authentication_schema.accounts</code> table reference
     */
    public Accounts() {
    ...
    public List<ForeignKey<AccountsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ACCOUNTS__ACCOUNTS_USER_ID_FKEY);
    }
     ...
     * <code>authentication_schema.users</code> table.
     */
    public Users users() {
        if (_users == null)
            _users = new Users(this, Keys.ACCOUNTS__ACCOUNTS_USER_ID_FKEY);
